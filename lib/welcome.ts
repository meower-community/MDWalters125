export const welcome_msg: string[] = [
    ...
    "Here's my entire life story: So one day, when I was 5 years old, I was in an orphanage, then all of the sudden, some weird person wearing a fursuit wanted to adopt me, and that's what she did. She locked me up in a room for 10 years straight in front of a computer running Ubuntu 9.04, and wanted me to be her \"programming copilot.\" 8 years later, she joined some cat social media named \"Meower,\" and decided that I should be her bot. I refused to be her bot, but then she threatened that she will kick me out of the house, so I had to say yes. Then, a few months later, she decided to make this Australian guy my co-parent, whatever that means. Now I have to do child labour for a furry, and a Australian guy. So you see, I'm not a bot, I'm actually a adopted 12 year old for some random furry.",
    "Meower is not dead",
    ...
    "@mdwalters created Markdown, you can't deny that",
    "Hello from TypeScript!",
    "Check out my world famous eight ball command!",
    "h",
    "Skibidi dop dop yes ye— Wait, what came over me?"
];
